...
{
	TMap<int32, int32 >  WordLengthToMaxTries{ {3,4}, {4,7}, {5,8}, {6,12}, {7,16} };
...
{
	// Treat 0 and 1 letter string words as isograms
	...
	return true; // example, where cases of /0 is entered
}
